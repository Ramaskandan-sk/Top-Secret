...
import { supabase, encryptSecret } from "@/lib/supabase";
...
export default function NewKey() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const encryptedSecret = await encryptSecret(validated.secret);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Add New API Key</h1>
          <p className="text-muted-foreground">Store a new API key securely</p>
        </div>
      </div>
